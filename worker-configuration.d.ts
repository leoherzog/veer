/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6c9d159b5cffac88bf6026e6111094bc)
// Runtime types generated with workerd@1.20260507.1 2026-03-06 nodejs_compat_v2
declare namespace Cloudflare {
	...
	interface DemoEnv {
		...
		ANALYTICS: AnalyticsEngineDataset;
		ASSETS: Fetcher;
		WORKER_NAME: "veer-demo";
		INSTANCE_NAME: "Veer Demo";
		DEMO_MODE: "true";
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
		PASSKEY_ENABLED: string;
	...
	interface Env {
		...
		ANALYTICS: AnalyticsEngineDataset;
		ASSETS: Fetcher;
		WORKER_NAME: "veer-staging" | "veer-demo" | "veer";
		INSTANCE_NAME: "" | "Veer Demo";
		DEMO_MODE: "" | "true";
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
